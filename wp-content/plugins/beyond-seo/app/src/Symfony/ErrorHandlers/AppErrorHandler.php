...
class AppErrorHandler extends ErrorHandler
{
    ...
    public static function register(?ErrorHandler $handler = null, bool $replace = true): self
    {
        ...
        $nonDeprecationErrors = E_ALL & ~E_NOTICE & ~E_USER_NOTICE & ~2048 & ~E_DEPRECATED & ~E_USER_DEPRECATED;
        ...
        $nonDeprecationErrors = E_ALL & ~E_DEPRECATED & ~E_USER_DEPRECATED & ~E_NOTICE & ~2048;
