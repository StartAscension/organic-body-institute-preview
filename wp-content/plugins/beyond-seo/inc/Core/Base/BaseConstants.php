...
class BaseConstants
{
    ...
    public const OPTION_DELETE_ON_DEACTIVATION = 'rankingcoach_delete_on_deactivation';
    ...
    public const OPTION_ACCESS_TOKEN_EXPIRES_AT = 'rankingcoach_access_token_expires_at';
    ...
    // List of owned plan packets (a customer may own several at once, e.g. momentum_search, momentum_reputation, momentum_marketing)
