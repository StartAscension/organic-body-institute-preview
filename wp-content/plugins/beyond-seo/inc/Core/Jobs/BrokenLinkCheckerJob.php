 ...
 * 
 * Handles scheduled broken link checking across all posts and pages using WP Cron.
 ...
 */
class BrokenLinkCheckerJob extends CronJobClass
{
    /** @var string The Cron hook name for broken link checking */
     ...
     * This method is called by WP Cron when the scheduled action runs.
     *
