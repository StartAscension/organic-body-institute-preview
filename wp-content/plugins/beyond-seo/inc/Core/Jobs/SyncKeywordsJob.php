 ...
 * 
 * Handles keyword synchronization with RankingCoach platform using WP Cron.
 ...
 */
class SyncKeywordsJob extends CronJobClass
{
    /** @var string The Cron hook name for keyword synchronization */
