 ...
 * 
 * Handles automatic synchronization of customer account data using WP Cron.
 ...
 */
class AccountSyncJob extends CronJobClass
{
    use RcLoggerTrait;

    /** @var string The Cron hook name for account sync */
