...
$currentVersion = get_plugin_data(  RANKINGCOACH_FILE, false, false)['Version'];
...
if (defined('RANKINGCOACH_FILE')) {
    ...
    defined('RANKINGCOACH_PLUGIN_BASENAME') || define('RANKINGCOACH_PLUGIN_BASENAME', (defined('IONOS_IS_STRETCH') ? 'plugins/' : '')  . RANKINGCOACH_FILENAME . DIRECTORY_SEPARATOR . 'beyond-seo.php');
}
...
// === Logging ===
defined('RANKINGCOACH_LOG_DIR')                     || define('RANKINGCOACH_LOG_DIR',   wp_upload_dir()['basedir'] . DIRECTORY_SEPARATOR . 'rc-logs' . DIRECTORY_SEPARATOR);
